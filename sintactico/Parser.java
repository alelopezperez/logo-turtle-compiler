...
public class Parser {
	...
	private void LS() throws SyntaxError {
		if (token.equals("IF") || token.equals("WHILE") || token.equals("VAR") || 
			token.equals("ID") || token.equals("PRINT") || token.equals("PENUP") || token.equals("PENDOWN") || token.equals("FD") || token.equals("BK") ||
			token.equals("LT") || token.equals("RT")) {
			S();
			LS();
		} else {
			// do nothing -> epsilon
