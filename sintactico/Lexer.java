		...
		try {
			...
			if (t == st.TT_EOF) {
				...
				if (getStringValue().equals("print")) {
					...
					current = "VAR";
				} else if (getStringValue().equals("penup")) {
					current = "PENUP";
				} else if (getStringValue().equals("pendown")) {
					current = "PENDOWN";
				} else if (getStringValue().equals("fd")) {
					current = "FD";
				} else if (getStringValue().equals("bk")) {
					current = "BK";
				} else if (getStringValue().equals("rt")) {
					current = "RT";
				} else if (getStringValue().equals("lt")) {
					current = "LT";
				} else {
					current = "ID";
				}
